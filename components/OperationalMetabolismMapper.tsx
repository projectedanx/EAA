...
const OperationalMetabolismMapper: React.FC = () => {
  ...
  if (isValid) {
      ...
      if (normA > 0 && normB > 0) {
          ...
          cfdi = (topologicalStrain * epsilonInput) / Math.max(0.1, cosineAlignment + 1.0);
      }
  }
                        ...
                        {cfdi > 1e-5 ? (
                            ...
                            <div className="bg-green-900/30 border border-green-500/50 p-3 rounded flex items-start">
                                ...
                                <div className="text-xs text-green-300">
                                    <strong>Paraconsistent State Stable.</strong> The contradictory vectors are successfully held in tension without Boolean collapse.
                                </div>
                            </div>
                        )}
                    </div>
